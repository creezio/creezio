...
export const tempoflow3Manifest: AppManifest = {
  ...
  "tunnelRootDomain": "tempoflow3.local",
  "domains": {
    "primary": "tempoflow3.local",
    "feedHost": "tempoflow3.local"
  },
  "copyright": "© TempoFlow",
  "client": {
    ...
    "feedUrl": "https://tempoflow3.local/dl-sandboxa6dd97fbd7ea5672b283334a/",
