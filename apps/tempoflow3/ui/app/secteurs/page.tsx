...
export default async function Page() {
  ...
  return (
    <section>
      <h1>Secteurs</h1>
      <p>Entité <code>secteurs</code> — {items.length} élément(s).</p>
      <ul>
        {items.map((item) => (
