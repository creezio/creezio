...
export default async function Page() {
  ...
  return (
    <section>
      <h1>Scan</h1>
      <p>Entité <code>scan_sessions</code> — {items.length} élément(s).</p>
      <ul>
        {items.map((item) => (
