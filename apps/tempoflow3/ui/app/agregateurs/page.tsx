...
export default async function Page() {
  ...
  return (
    <section>
      <h1>Agrégateurs</h1>
      <p>Entité <code>agregateurs</code> — {items.length} élément(s).</p>
      <ul>
        {items.map((item) => (
