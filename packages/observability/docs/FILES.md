...
| [`fleet-collector/instance-stack.mjs`](../fleet-collector/instance-stack.mjs) | Stack compose par instance : rendu app (+ cf.env 0.10) ; update **préserve** un sidecar `cloudflared*` (patch image seule) et **refuse** si hostname public persisté sans tunnel (fail-closed 0.10.3). |
