...
| [`src/mount-brand-mcp-surface.ts`](../src/mount-brand-mcp-surface.ts) | Surface MCP/admin : OAuth, MCP admin, Database, Analytics usage, registre endpoints (`listOperations` + Hono admin) + stub OpenAPI `/api/v1/openapi.json` |
