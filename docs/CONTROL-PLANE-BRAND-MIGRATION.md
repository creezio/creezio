...
| 2 | Brancher `createSqliteProductHubStore` (ou store existant) | ☐ | ☐ | ☐ |
| 3 | Remplacer HTTP local par `startHostPluginControlPlane` | ☐ I10 | ☐ I16 | ☐ I18 |
| 4 | Passer `acl: createPluginControlPlaneAclFromStore(...)` | ☐ I10 | ☐ I16 | ☐ I18 |
| 5 | Headers actor `buildPluginAclActorHeaders` / `x-creezio-org-id` | ☐ | ☐ | ☐ |
| 6 | Garder adapters verticaux (git, accept-check, grants CRM) | ☐ | ☐ | ☐ |
| 7 | Tests deny cross-org + owner install OK | ☐ | ☐ | ☐ |
| 8 | Retirer `plugin-control-api.ts` mort après verts | ☐ | ☐ | ☐ |
