...
**Mission : SUCCESS** (52 pass / 0 fail)
...
| `os.tasks-create` | ✅ | 90997d91-ecad-42d1-9359-6d43d5a9288c |
...
| `os.n8n-ensure` | ✅ | /tmp/tf3-hard-tbCHUU/n8n-runtime/node_modules/n8n/bin/n8n |
| `os.n8n-start` | ✅ | /tmp/tf3-hard-tbCHUU/n8n-runtime/node_modules/n8n/bin/n8n |
| `os.hermes-ensure` | ✅ | /tmp/tf3-hard-tbCHUU/hermes-runtime/os-profile/.hermes/hermes-agent/venv/bin/hermes |
| `os.hermes-start` | ✅ | /tmp/tf3-hard-tbCHUU/hermes-runtime/os-profile/.hermes/hermes-agent/venv/bin/hermes |
| `os.tunnel-status` | ✅ | mcp=http://127.0.0.1:19539/mcp |
| `os.mcp-public` | ✅ | status=200 tools=7 |
| `metier.fournisseur` | ✅ | dca079fd-fba2-4abf-bae2-9e347a985f10 |
| `metier.commande` | ✅ | 5d86a738-8cb3-404c-8396-4c70df33c6c1 |
| `metier.optimiser` | ✅ | status=200 |
| `metier.optimiser-apply` | ✅ | status=200 |
| `metier.stack-add` | ✅ | ok |
| `metier.stack-list` | ✅ | n=1 |
| `metier.stack-panier` | ✅ | ok |
| `metier.releve-create` | ✅ | lignes=3 id=14f2647d-a51c-44d2-9e3c-6f700f0928b0 |
| `metier.releve-apply-prix` | ✅ | promo_label=releve:14f2647d-a51c-44d2-9e3c-6f700f0928b0 |
