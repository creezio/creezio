...
| `os.tasks-create` | ✅ | a8ef8e09-31ac-46fb-9f3b-740ff0e7d150 |
...
| `os.n8n-ensure` | ✅ | /tmp/tf3-hard-J6SoSq/n8n-runtime/node_modules/n8n/bin/n8n |
| `os.n8n-start` | ✅ | /tmp/tf3-hard-J6SoSq/n8n-runtime/node_modules/n8n/bin/n8n |
| `os.hermes-ensure` | ✅ | /tmp/tf3-hard-J6SoSq/hermes-runtime/os-profile/.hermes/hermes-agent/venv/bin/hermes |
| `os.hermes-start` | ✅ | /tmp/tf3-hard-J6SoSq/hermes-runtime/os-profile/.hermes/hermes-agent/venv/bin/hermes |
| `os.tunnel-status` | ✅ | mcp=http://127.0.0.1:19687/mcp |
| `os.mcp-public` | ✅ | status=200 tools=7 |
| `metier.fournisseur` | ✅ | 1dd9120b-b8de-430a-bfea-248abb56d4b5 |
| `metier.commande` | ✅ | c9430a52-dc53-4080-bffb-aae843cda2a7 |
...
| `metier.releve-create` | ✅ | lignes=3 id=91796b2a-bf92-43f4-91d7-a5237bf2b019 |
| `metier.releve-apply-prix` | ✅ | promo_label=releve:91796b2a-bf92-43f4-91d7-a5237bf2b019 |
...
| `metier.commande-version-create` | ✅ | f751411c-8cb8-404a-9768-c104c8bcdc6e |
...
| `os.mcp-oauth-status` | ✅ | oauthReady=true public=http://127.0.0.1:19687 |
| `os.mcp-oauth-well-known` | ✅ | http://127.0.0.1:19687 |
| `os.mcp-admin-status` | ✅ | status=200 oauthReady=true |
| `os.tasks-kanban-create` | ✅ | 5f9dd5ac-67f5-4334-85b7-f47e35adc7f4 |
