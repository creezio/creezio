/**
 * Phase C0 — docs/gates/matrice = état réel + backlog C*.
 */
...
test("C0 livrables docs présents", () => {
  for (const p of [
    "docs/PHASE-C0.md",
    "docs/MATRICE-NATIVE-METIER-PLUGIN.md",
    "docs/REPUBLISH-POLICY.md",
    "docs/gates/POST-H5.md",
    "docs/VISION-V1-V3.md",
  ]) {
...
test("C0 POST-H5 versions marques réelles", () => {
  const post = read("docs/gates/POST-H5.md");
...
test("C0 matrice marque dual-write / demi-mesures 🟡", () => {
  const m = read("docs/MATRICE-NATIVE-METIER-PLUGIN.md");
...
test("C0 PHASE-C0 backlog C1–C8", () => {
  const c0 = read("docs/PHASE-C0.md");
...
test("C0 REPUBLISH-POLICY lignes C*", () => {
  const pol = read("docs/REPUBLISH-POLICY.md");
...
test("C0 VISION addendum correction C*", () => {
  const v = read("docs/VISION-V1-V3.md");
